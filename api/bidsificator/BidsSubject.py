...
if os_name == "Darwin":
    if 'x86_64' in machine.lower():
        ...
        from bidsificator.PyEEGFormat import wrappermacarm as wrapper
elif os_name == "Windows":
    from bidsificator.PyEEGFormat import wrapperwin as wrapper
elif os_name == "Linux":
    if 'x86_64' in machine.lower():
        from bidsificator.PyEEGFormat import wrapperlinux as wrapper
    elif 'arm' in machine.lower():
        from bidsificator.PyEEGFormat import wrapperlinuxarm64 as wrapper
else:
