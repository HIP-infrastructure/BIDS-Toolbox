...
RUN git clone https://github.com/CHORUS-TRE/PyEEGBids.git

ADD "https://api.github.com/repos/CHORUS-TRE/PyEEGBids/commits?sha=main&per_page=1" pyeebids_latest_commit

RUN cd PyEEGBids && git checkout main && git pull && \
